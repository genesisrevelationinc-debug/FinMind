...
The `/insights/weekly` endpoint provides a summary of expenses and bills for the current week.
The `/insights/weekly/trends` endpoint provides trends such as the highest expense category for the current week.
