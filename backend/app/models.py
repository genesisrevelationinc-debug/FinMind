...
User.savings_goals = relationship("SavingsGoal", order_by=SavingsGoal.created_at, back_populates="user")
SavingsGoal.milestones = relationship("Milestone", order_by=Milestone.created_at, back_populates="savings_goal")